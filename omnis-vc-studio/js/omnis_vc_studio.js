(function($) {
    ...
    var images = $(".omnis-studio__template-thumb img");
    ...
    function setCatsColHeight() {
        omnisStudioCategoriesCol.css('height', '');
        var panelHeight = (omnisStudio.closest('.vc_ui-panel-content-container').length !== 0) ? omnisStudio.closest('.vc_ui-panel-content-container')[0].getBoundingClientRect().height : 0;

        if (parseInt(panelHeight) !== 0 && parseInt(window.innerWidth) > 860) {
    ...
    omnisStudio.on( 'click', '.omnis-studio__categories a, .omnis-studio__template-categories a', function(e) {
        e.preventDefault();
        ...
        $('.omnis-studio__categories-list').children().removeClass('active');
        $('.omnis-studio__categories-list').find('a[data-name="'+ filterValue +'"]').parent().addClass('active');
    });
